                ...
                {session?.user?.role === "Organizer" ? (
                  <>
                    <Link
                      ...
                      className={`nav-link ${
                        pathname === "/OrganizerDashboard" ? "active" : ""
                      }`}
                    >
                      <FontAwesomeIcon
                  ...
                  <>
                    <div className="justify-between w-[80%] md:w-[65%] md:hidden max-sm:hidden lg:flex 2xl:flex">
                      <Link
                        className="text-[#838086] hover:text-[#ffffff] transform hover:translate-y-[-2px] transition-transform transform hover:translate-y-[-2px] transition-all duration-300 ease-in-out;"
                        href="/AdminDashboard"
                      >
                        <FontAwesomeIcon
                          className="text-sm mr-1"
                      ...
                      {settingsDropDownOpen ||
                        (isHovered && (
                          <div
                            ...
                            className="absolute bg-[#0f0f0f] z-10 border border-[#343434] p-4 rounded-md xl:top-[10%] lg:top-[11.5%] lg:left-[24%] md:top-[13%] top-[11%]"
                          >
                            <div className="flex flex-col gap-2">
                              ...
                              >
                                <div>
                                  ...
                                  <p className="text-sm">
                                    manage user accounts for students,
                                    organizers, and other admins.
                                  </p>
                                </div>
                              </Link>
                            </div>
                  ...
                  <>
                    <Link
                      href="/Events"
                      className={`nav-link items-center gap-2 mr-8 xl:flex lg:flex ${
                    ...
                    <Link
                      href="/Calendar"
                      className={`nav-link items-center gap-2 xl:flex lg:flex ${
