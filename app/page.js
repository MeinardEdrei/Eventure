      ...
      <div className="main-container">
        <div className="w-[86%] mr-2 mt-6">
          ...
          <section className="relative">
            ...
            <div
              name="top-left"
              className="absolute xl:right-[24%] lg:top-[-2%]  lg:right-[36%]
            ...
            <div className="flex justify-center absolute bg-white px-4 py-2 w-52 lg:top-[7%] left-[7%] rounded-full
              lg:w-64 lg:left-[3%] md:top-[7%] max-sm:bottom-[6%] max-sm:w-40 max-sm:left-[10%]">
              <p className="text-black text-sm font-medium
              lg:text-lg max-sm:text-xs">November 30, 2023</p>
            </div>
            <div className="flex justify-center absolute px-4 py-2 w-[50%] rounded-full bottom-[14%] left-[3%] 
              md:left-[6%] max-sm:left-[7%]">
              <p className="text-white text-lg font-bold
              lg:text-3xl lg:bottom-[7%] lg:left-[3%] md:text-2xl max-sm:text-sm">The long awaited concert this 2023 with UMAK Jammers</p>
            </div>
            <div className="z-10 flex items-center text-center justify-center absolute top-[40%] lg:right-[10%] max-sm:left-[10%] bg-white w-48 rounded-full 
              lg:px-3 lg:py-2 md:right-[5%] max-sm:w-36 max-sm:top-[42%]">
              <p className="text-black text-sm font-medium mx-3
              lg:text-base max-sm:text-xs">See all events</p>
              <p className="text-black text-3xl max-sm:text-lg">→</p>
            </div>
