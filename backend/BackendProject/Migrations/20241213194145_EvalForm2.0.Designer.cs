...
namespace BackendProject.Migrations
{
    ...
    [Migration("20241213194145_EvalForm2.0")]
    partial class EvalForm20
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackendProject.Models.EvaluationCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendProject.Models.EvaluationQuestion", b =>
                {
                    ...
                    b.Property<int>("EvaluationCategoryId")
                        .HasColumnType("int")
                        .HasColumnName("EvaluationCategoryId");
            ...
            modelBuilder.Entity("BackendProject.Models.RejectionReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendProject.Models.SchoolYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackendProject.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Attended_Events = 0,
                            Created_At = new DateTime(2024, 12, 14, 3, 41, 43, 789, DateTimeKind.Local).AddTicks(3005),
                            Created_Events = 0,
                            Department = "Administration",
                            Email = "admin@umak.edu.ph",
                            Password = "$2a$11$ZshfXSjbrumWNiSzM5S2XuoQWgALDQrLxdLS2PO1fq/NrIka2CtUy",
                            Profile_Image = "",
                            Role = "Admin",
            ...
            modelBuilder.Entity("BackendProject.Models.EvaluationQuestion", b =>
                {
                    b.HasOne("BackendProject.Models.EvaluationCategory", "EvaluationCategory")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("BackendProject.Models.Event", b =>
                {
                    b.HasOne("BackendProject.Models.SchoolYear", "SchoolYear")
                        .WithMany()
